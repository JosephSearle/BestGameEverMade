...
public class FirstPersonAIO : MonoBehaviour {
    ...
    private void Start(){
        ...
        if(autoCrosshair || drawStaminaMeter){
            ...
            HealthBarBG = new GameObject("HealthMeter").AddComponent<Image>();
            HealthBar = new GameObject("Health").AddComponent<Image>();
            HealthBar.transform.SetParent(HealthBarBG.transform);
            HealthBarBG.transform.SetParent(canvas.transform);
            HealthBarBG.transform.position = Vector3.zero;
            HealthBarBG.rectTransform.anchorMax = new Vector2(0.5f,0);
            HealthBarBG.rectTransform.anchorMin = new Vector2(0.5f,0);
            HealthBarBG.rectTransform.anchoredPosition = new Vector2(-250,410);
            HealthBarBG.rectTransform.sizeDelta = new Vector2(250,15);
            HealthBarBG.color = new Color(0.75f,0,0,1);
            HealthBar.rectTransform.sizeDelta = new Vector2(250,15);
            HealthBar.color = new Color(1,1,1,0);

            ManaBarBG = new GameObject("ManaMeter").AddComponent<Image>();
            ManaBar = new GameObject("Mana").AddComponent<Image>();
            ManaBar.transform.SetParent(ManaBarBG.transform);
            ManaBarBG.transform.SetParent(canvas.transform);
            ManaBarBG.transform.position = Vector3.zero;
            ManaBarBG.rectTransform.anchorMax = new Vector2(0.5f,0);
            ManaBarBG.rectTransform.anchorMin = new Vector2(0.5f,0);
            ManaBarBG.rectTransform.anchoredPosition = new Vector2(-250,395);
            ManaBarBG.rectTransform.sizeDelta = new Vector2(250,6);
            ManaBarBG.color = new Color(0,0.50f,1,1);
            ManaBar.rectTransform.sizeDelta = new Vector2(250,6);
            ManaBar.color = new Color(1,1,1,0);
